...
class PercentageDiscountProcessor(PromoProcessor):
    ...
    def calculate_deal(self, item, match):
        ...
        discount_amount = item_data.get("sale_price", item_data.get('regular_price', 0)) * (discount_percentage / 100)
    ...
    def calculate_coupon(self, item, match):
        ...
        discount_amount = item_data.get("unit_price", 0) * (discount_percentage / 100)
